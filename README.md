...
* Designed and implemented RESTful APIs powering AI-enabled platforms, integrating with ML-based services and third-party systems.
* Built responsive, data-heavy data usage applications using Angular and Python backends (Django, Flask, FastAPI), processing real-time data streams.
